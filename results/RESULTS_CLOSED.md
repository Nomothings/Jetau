...
| Task | No memory | Prompt memory | Jet-0.6B | Jet-0.6B-Mix |
|---|---:|---:|---:|---:|
...
Mind2Web (official metric is step-level): no memory 0.132 / prompt 0.133 / Jet-0.6B 0.631 / Mix 0.546.

WebShop strict success (r=1.0): no memory 10.2% / prompt 12.0% / Jet-0.6B 43.2%.
